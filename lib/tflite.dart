...
class Tflite {
  ...
  static List<int> pascalVOCLabelColors = [
    ...
    Color.fromARGB(255, 128, 0, 0).value,
    Color.fromARGB(255, 0, 128, 0).value,
    Color.fromARGB(255, 128, 128, 0).value,
    Color.fromARGB(255, 0, 0, 128).value,
    Color.fromARGB(255, 128, 0, 128).value,
    Color.fromARGB(255, 0, 128, 128).value,
    Color.fromARGB(255, 128, 128, 128).value,
    Color.fromARGB(255, 64, 0, 0).value,
    Color.fromARGB(255, 192, 0, 0).value,
    Color.fromARGB(255, 64, 128, 0).value,
    Color.fromARGB(255, 192, 128, 0).value,
    Color.fromARGB(255, 64, 0, 128).value,
    Color.fromARGB(255, 192, 0, 128).value,
    Color.fromARGB(255, 64, 128, 128).value,
    Color.fromARGB(255, 192, 128, 128).value,
    Color.fromARGB(255, 0, 64, 0).value,
    Color.fromARGB(255, 128, 64, 0).value,
    Color.fromARGB(255, 0, 192, 0).value,
    Color.fromARGB(255, 128, 192, 0).value,
    Color.fromARGB(255, 0, 64, 128).value,
  ];
